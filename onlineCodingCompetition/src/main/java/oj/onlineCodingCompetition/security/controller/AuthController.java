...
import oj.onlineCodingCompetition.security.dto.MessageResponse;
import oj.onlineCodingCompetition.security.dto.SignupRequest;
import oj.onlineCodingCompetition.security.jwt.JwtUtils;
...
public class AuthController {
    ...
    public ResponseEntity<?> authenticateUser(@Valid @RequestBody LoginRequest loginRequest) {
        ...
        return ResponseEntity.ok(new JwtResponse(
                ...
                roles,
                userDetails.getContestRegistrationIds()
        ));
    }
    ...
    public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
        ...
        user.setSubmissions(new HashSet<>());
        user.setContestRegistrations(new HashSet<>());
